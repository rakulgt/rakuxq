...
project_id: rakuxq
baseline_revision: "16"
parent_revision: "15"
change_operation: UPDATE
status: active
updated_at: "2026-09-25T21:10:00+08:00"
---
...
- 方向归一化后，若唯一红帅落在黑方九宫、唯一黑将落在红方九宫，并且全局交换阵营可严格减少阻断性违法，允许应用可审计的整盘阵营纠正；缺失主帅、单方越界或纠正后未改善时不得触发，且纠正不能覆盖其他低置信或类型错误。
