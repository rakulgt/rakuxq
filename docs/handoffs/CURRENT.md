...
基线时间：`2026-09-17T19:06:00+08:00`
当前稳定版本：`v0.2.0-alpha.1`
...
- 生产运行状态：服务器发布标识为 `0dc86d4acc91ba8e93b51719f2c3315257fbf536`；服务 `active`、`NRestarts=0`，短期清理与匿名统计备份 timer 均为 `active`，Nginx 配置检查通过。
